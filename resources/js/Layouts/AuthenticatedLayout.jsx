                        ...
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item">
                                <Link href="/orders" className="nav-link">
                                    <i className="bi bi-list-ul"></i> Замовлення
                                </Link>
                            </li>
                            {user?.role === 'admin' && (
                                <li className="nav-item">
                                    <Link href="/admin" className="nav-link text-warning">
                                        <i className="bi bi-gear"></i> Адмін
                                    </Link>
                                </li>
                            )}
                            <li className="nav-item">
                                <Link href="/logout" method="post" as="button" className="nav-link">
                                    <i className="bi bi-box-arrow-right"></i> Вихід ({user?.name})
                                </Link>
                            </li>
                        </ul>
                    </div>
